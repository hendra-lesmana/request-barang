        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              _this4.request.items.forEach(function (item) {
                var availableItemIndex = _this4.availableItems.findIndex(function (i) {
                  return i.id === item.barang;
                });
                if (availableItemIndex !== -1) {
                  _this4.availableItems[availableItemIndex] = _objectSpread(_objectSpread({}, _this4.availableItems[availableItemIndex]), {}, {
                    jumlah_stok: _this4.availableItems[availableItemIndex].jumlah_stok - item.kuantiti
                  });
                }
              });
